...
BACKTEST_PERIOD_DAYS = 90  # Backtest duration in days (3 months)
GRID_SEARCH = True  # Set to True to enable grid search in backtest
SEQUENCE_LENGTH = 15  # Reduced to 15 for free tier historical data limit
NUM_DAYS_HISTORY = 5  # Increased for more context
UPPER_THRESHOLD = 0.65  # Default for single run
LOWER_THRESHOLD = 0.35  # Default for single run
UPPER_THRESHOLDS = [0.6, 0.65, 0.7]  # For grid search
LOWER_THRESHOLDS = [0.3, 0.35, 0.4]  # For grid search
...
SUPPORTS = {"AAPL": [211.00, 212.00, 213.00], "NVDA": [148.00, 171.00, 172.00], "AMD": [160.00, 163.00, 168.00]}
RESISTANCES = {"AAPL": [214.00, 215.00, 217.00], "NVDA": [173.00, 174.00, 178.00], "AMD": [172.00, 173.00, 177.00]}
