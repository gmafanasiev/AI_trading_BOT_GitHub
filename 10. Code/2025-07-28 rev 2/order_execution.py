...
from config import open_positions, sl_prices, tp_prices, STOP_LOSS_PCT, TAKE_PROFIT_PCT, TRADE_MODE, POLL_TIMEOUT, BACKTEST
...
async def get_position(trading_client: TradingClient, symbol: str) -> float:
    ...
    if TRADE_MODE == 'simulation' or BACKTEST:
